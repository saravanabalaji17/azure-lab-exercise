...
## **Part 5 – Create Resource Group, VNet, Subnet and NSG and allow SSH (22), HTTP (80), RDP (3389)**
...
List all rules of an NSG
 az network nsg rule list --resource-group vsphere-rg --nsg-name vsphere-nsg --output table
...
```
### (D) ** (Optional) Update existing VM size (VM must be stopped)**
